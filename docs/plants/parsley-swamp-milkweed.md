...
<div class="plant-hero">
  ...
  <div class="plant-facts">
    <h3>Quick Facts</h3>
    <ul>
      <li><strong>USDA zones:</strong> All (parsley) • 3–9 (milkweed)</li>
      <li><strong>Sun:</strong> Full sun to part shade</li>
      <li><strong>Water:</strong> Average to moist</li>
      <li><strong>Height:</strong> Parsley 1–2 ft • Milkweed 3–5 ft</li>
    </ul>
    <p><strong>Primary Use:</strong> Double butterfly host → Swallowtail + Monarch</p>
  </div>
</div>

<div class="full-width">
  <h3>Wildlife Supported</h3>
  <p>Parsley → Black Swallowtail • Swamp Milkweed → Monarch (only food for caterpillars)</p>

  <h3>Pests to Watch</h3>
  <p>Caterpillars → **DO NOT KILL** — they’re the whole point!</p>

  <h3>Unusual / Fun Facts</h3>
  <p>Swamp milkweed smells like vanilla when blooming</p>

  <h3>Local Care Tips (The Villages 9b)</h3>
  <p>Pos 7 (future) • Parsley moving from small pot 5a</p>
</div>

<hr>
<p style="text-align:center;">
  <a href="/FloridaLiving/plants/bronze-fennel.html">← Previous: Bronze Fennel & Dill</a> • 
