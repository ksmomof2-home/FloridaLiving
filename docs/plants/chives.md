...
<div class="plant-hero">
  ...
  <div class="plant-facts">
    <h3>Quick Facts</h3>
    <ul>
      <li><strong>USDA zones:</strong> 3–9 (perennial)</li>
      <li><strong>Sun:</strong> Full sun to part shade</li>
      <li><strong>Water:</strong> Average</li>
      <li><strong>Height:</strong> 12–18 inches</li>
    </ul>
    <p><strong>Primary Use:</strong> Culinary → onion flavor, pretty purple flowers</p>
  </div>
</div>
...
<div class="full-width">
  ...
  <ul>
    <li>Nectar for small bees & butterflies</li>
  </ul>

  <h3>Pests to Watch</h3>
  <ul>
    <li>Almost none — very tough</li>
  </ul>

  <h3>Unusual / Fun Facts</h3>
  <ul>
    <li>Flowers are edible and taste like mild onion</li>
  </ul>

  <h3>Local Care Tips (The Villages 9b)</h3>
  <ul>
    <li>Small pot 1a • Chive seeds planted Nov 22</li>
  </ul>
</div>
...
<table class="log-table table-notes">
  ...
  <tr><td>Nov 22, 2025</td><td>Purple flowers coming soon — baked potato topping!</td></tr>
</table>

<hr>
<p style="text-align:center;">
  <a href="/FloridaLiving/plants/rosemary-oregano.html">← Previous: Rosemary + Italian Oregano</a> • 
  <a href="/FloridaLiving/plants/wandering-jew.html">Next: Wandering Jew →</a>
  <br><br>
